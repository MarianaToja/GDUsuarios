...
public void loginUsuario(String nome, String senha) {
     ...
     for (Usuario usuario : usuarios) {
         if (usuario.getNome().equals(nome) && usuario.getSenha().equals(senha)) {
        	 ...
        	 System.out.println("Nome ou senha inválida, tente efetuar o login novamente");
         }
     }
...
public void trocarSenha(String nome, String senha) {
	List<Usuario> usuarios = lerUsuarios();
	...
	for (Usuario usuario : usuarios) {
	    if (usuario.getNome().equals(nome) && usuario.getSenha().equals(senha)) {
	    	...
	    	System.out.println("Nome ou senha inválida");
